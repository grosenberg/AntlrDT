...
/**
 * A layering algorithm that places nodes in layers. The algorithm is similar to that described in
 * <cite>Coffman, E. G., Jr. and Graham, R. L., "Optimal scheduling for two-processor systems", Acta
 * Informatica (1972).</cite>
 */
