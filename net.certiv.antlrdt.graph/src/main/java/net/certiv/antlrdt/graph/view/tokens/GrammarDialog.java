...
import static net.certiv.antlrdt.graph.parse.GrammarRecord.*;
...
import net.certiv.antlrdt.graph.fields.DirField;
import net.certiv.antlrdt.graph.fields.FileField;
