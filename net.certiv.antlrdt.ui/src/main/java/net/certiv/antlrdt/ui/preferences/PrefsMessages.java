package net.certiv.antlrdt.ui.preferences;

import org.eclipse.osgi.util.NLS;

public class PrefsMessages extends NLS {

	private static final String BUNDLE_NAME = "net.certiv.antlrdt.ui.preferences.PrefsMessages";//$NON-NLS-1$	

	private PrefsMessages() {}

	static {
		NLS.initializeMessages(BUNDLE_NAME, net.certiv.antlrdt.ui.preferences.PrefsMessages.class);
	}
