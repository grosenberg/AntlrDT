/*******************************************************************************
 * Copyright 2005-2009, Gerald B. Rosenberg, Certiv Analytics . All rights reserved. This program
 ...
 *******************************************************************************/
package net.certiv.antlrdt.ui.graph.layouts;
...
public class BranchedLayoutAlgorithm extends AbstractLayoutAlgorithm {
	...
	protected void applyLayoutInternal(InternalNode[] entitiesToLayout, InternalRelationship[] relationshipsToConsider,
		...
		// TODO: reduce globals?
		blockList = new ArrayList<Block>(); // capture of child blocks
		completedLayout = new ArrayList<InternalNode>(); // used to prevent cycles
	...
	private void constructVirtualLayout(ArrayList<InternalNode> entitiesList,
		...
		roots = new ArrayList<InternalNode>(entitiesList);
		virt = new LinkedHashMap<InternalNode, ArrayList<InternalRelationship>>();
		ArrayList<InternalNode> parentedList = new ArrayList<InternalNode>();

		for (InternalNode entity : entitiesList) {
			ArrayList<InternalRelationship> relations = new ArrayList<InternalRelationship>();
	...
	class Block extends ArrayList<InternalNode> {
		...
		public Block(InternalNode source) {
			this.source = source;
			this.childList = new ArrayList<Block>();
		}
	...
	class LayoutData {
		...
		private ArrayList<LayoutData> childDataList = new ArrayList<LayoutData>();
