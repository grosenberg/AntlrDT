...
public class AntlrSimpleSourceViewerConfiguration extends AntlrSourceViewerConfiguration {
	...
	public AntlrSimpleSourceViewerConfiguration(IDslPrefsManager store, DslEditor editor, String partitioning) {
		super(null, store, editor, partitioning);
	}

	public AntlrSimpleSourceViewerConfiguration(IColorManager colorMgr, IDslPrefsManager store, DslEditor editor,
