...
public class AntlrDTImages extends DslImages {
	...
	public final ImageDescriptor DESC_OBJ_LABEL = create(locBundle, OBJ, locPrefix + "label_obj.png");
	public final ImageDescriptor DESC_OBJ_RULE_COLON = create(locBundle, OBJ, locPrefix + "ruleColon.png");
	public final ImageDescriptor DESC_OBJ_RULE = create(locBundle, OBJ, locPrefix + "ruleNode.png");
	public final ImageDescriptor DESC_OBJ_TERMINAL = create(locBundle, OBJ, locPrefix + "terminalNode.png");
	...
	public final ImageDescriptor IMG_LAYOUT_CALL = create(locBundle, OBJ, locPrefix + "icon_call_layout.png");
	public final ImageDescriptor IMG_LAYOUT_TREE_HORIZ = create(locBundle, OBJ,
			locPrefix + "icon_tree_layout_horizontal.png");
	public final ImageDescriptor IMG_LAYOUT_TREE = create(locBundle, OBJ, locPrefix + "icon_tree_layout.png");
	public final ImageDescriptor IMG_LAYOUT_RADIAL = create(locBundle, OBJ, locPrefix + "icon_radial_layout.png");
	public final ImageDescriptor IMG_LAYOUT_SPRING = create(locBundle, OBJ, locPrefix + "icon_spring_layout.png");
	public final ImageDescriptor IMG_LAYOUT_GRID = create(locBundle, OBJ, locPrefix + "icon_grid_layout.png");
	public final ImageDescriptor IMG_LAYOUT_GRAPHFLOW = create(locBundle, OBJ, locPrefix + "icon_graphflow_layout.png");
	public final ImageDescriptor IMG_LAYOUT_HORIZONTAL = create(locBundle, OBJ,
			locPrefix + "icon_horizontal_layout.png");

	public final ImageDescriptor IMG_ZOOM_IN = create(locBundle, OBJ, locPrefix + "zoomin_nav.png");
	public final ImageDescriptor IMG_ZOOM_OUT = create(locBundle, OBJ, locPrefix + "zoomout_nav.png");
	...
	public final ImageDescriptor IMG_SAVEEDIT = create(locBundle, OBJ, locPrefix + "save_edit.png");

	public final ImageDescriptor IMG_FORWARD_ENABLED = create(locBundle, OBJ, locPrefix + "forward_enabled.png");
	public final ImageDescriptor IMG_BACKWARD_ENABLED = create(locBundle, OBJ, locPrefix + "backward_enabled.png");
	public final ImageDescriptor IMG_REQ_PLUGIN_OBJ = create(locBundle, OBJ, locPrefix + "req_plugins_obj.png");
	public final ImageDescriptor IMG_SEARCH_CANCEL = create(locBundle, OBJ, locPrefix + "progress_rem.png");
	public final ImageDescriptor IMG_CLEAR = create(locBundle, OBJ, locPrefix + "clear_co.png");
	public final ImageDescriptor IMG_FOCUS = create(locBundle, OBJ, locPrefix + "focus_obj.png");
	public final ImageDescriptor IMG_PIN = create(locBundle, OBJ, locPrefix + "pin.png");

	public final ImageDescriptor IMG_CALLEES = create(locBundle, OBJ, locPrefix + "ch_callees.png");
	public final ImageDescriptor IMG_CALLERS = create(locBundle, OBJ, locPrefix + "ch_callers.png");
	public final ImageDescriptor IMG_SUPERTYPES = create(locBundle, OBJ, locPrefix + "super_co.png");
	public final ImageDescriptor IMG_SUBTYPES = create(locBundle, OBJ, locPrefix + "sub_co.png");
	public final ImageDescriptor IMG_REMOVE = create(locBundle, OBJ, locPrefix + "interest-filtering.png");
	public final ImageDescriptor IMG_GOTO = create(locBundle, OBJ, locPrefix + "goto_obj.png");

	public final ImageDescriptor IMG_ACTION_ADD_CALLERS = create(locBundle, OBJ, locPrefix + "ch_callers.png");
	public final ImageDescriptor IMG_ACTION_ADD_PATHS = create(locBundle, OBJ, locPrefix + "ch_callees.png");
	public final ImageDescriptor IMG_ACTION_REMOVE_PATHS = create(locBundle, OBJ, locPrefix + "remove_obj.png");
	...
	public final ImageDescriptor HIDDEN = create(locBundle, OBJ, locPrefix + "annotationOutlined.png");

	public final ImageDescriptor ERROR_NODE = create(locBundle, OBJ, locPrefix + "errorNode.png");
	public final ImageDescriptor UNKNOWN_NODE = create(locBundle, OBJ, locPrefix + "unknown_obj.png");
