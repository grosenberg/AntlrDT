...
public interface AntlrDT4ParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link AntlrDT4Parser#delegateElement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDelegateElement(AntlrDT4Parser.DelegateElementContext ctx);
	/**
	 * Visit a parse tree produced by {@link AntlrDT4Parser#delegate}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDelegate(AntlrDT4Parser.DelegateContext ctx);
	/**
