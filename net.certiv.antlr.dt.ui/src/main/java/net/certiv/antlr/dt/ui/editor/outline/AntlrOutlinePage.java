...
import net.certiv.antlr.dt.ui.editor.ActionMessages;
import net.certiv.antlr.dt.ui.editor.filter.AtFilter;
import net.certiv.antlr.dt.ui.editor.filter.OptionsFilter;
import net.certiv.antlr.dt.ui.editor.filter.RuleFilter;
import net.certiv.antlr.dt.ui.editor.filter.TokenFilter;
...
public class AntlrOutlinePage extends OutlinePage {
	...
	public AntlrOutlinePage(IPreferenceStore store) {
