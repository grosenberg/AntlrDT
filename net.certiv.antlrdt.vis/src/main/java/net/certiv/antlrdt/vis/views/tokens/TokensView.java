...
import net.certiv.antlrdt.vis.parse.ErrorRecord;
import net.certiv.antlrdt.vis.parse.GrammarRecord;
import net.certiv.antlrdt.vis.parse.ListProcessor;
import net.certiv.antlrdt.vis.parse.TargetBuilder;
import net.certiv.antlrdt.vis.util.VisUtil;
...
public class TokensView extends ViewPart {
	...
	public static final String VIEW_ID = "net.certiv.antlrdt.vis.views.tokens.TokensView";
