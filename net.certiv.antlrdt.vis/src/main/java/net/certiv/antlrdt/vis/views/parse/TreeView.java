...
import net.certiv.antlrdt.vis.actions.Layout;
import net.certiv.antlrdt.vis.actions.LayoutControlItem;
import net.certiv.antlrdt.vis.actions.Router;
import net.certiv.antlrdt.vis.actions.RouterControlItem;
import net.certiv.antlrdt.vis.actions.ScreenshotControlItem;
import net.certiv.antlrdt.vis.figures.ZoomControlItem;
import net.certiv.antlrdt.vis.model.PathNode;
import net.certiv.antlrdt.vis.model.providers.NodeContentProvider;
import net.certiv.antlrdt.vis.model.providers.NodeLabelProvider;
import net.certiv.antlrdt.vis.parse.TargetBuilder;
import net.certiv.antlrdt.vis.views.EnhGraphViewer;
import net.certiv.antlrdt.vis.views.IAdjustableViewPart;
import net.certiv.antlrdt.vis.views.ViewForm;
...
public class TreeView extends ViewPart implements IAdjustableViewPart, ISelectionListener/* , IShowInTarget */ {
	...
	public static final String ID = "net.certiv.antlrdt.vis.views.tree.TreeView";
	...
	// if (ed instanceof AntlrDTEditor) {
	// AntlrDTEditor editor = (AntlrDTEditor) ed;
	...
	private void createActions() {
		...
		linkAction.setActionDefinitionId(IWorkbenchCommandConstants.NAVIGATE_TOGGLE_LINK_WITH_EDITOR);
	}
	...
	class LinkAction extends Action {
		...
		private static final String LINKING = ID + ".linking";

		public LinkAction() {
			super("Link", SWT.TOGGLE);

			setToolTipText("Link with Editor");
			linking = store.getBoolean(LINKING);
			setChecked(linking);

			DslImageManager imgMgr = ui.getImageManager();
			setImageDescriptor(imgMgr.getDescriptor(imgMgr.IMG_LCL_SYNC));
		}

		@Override
		public void run() {
			linking = isChecked();
			store.setValue(LINKING, linking);
