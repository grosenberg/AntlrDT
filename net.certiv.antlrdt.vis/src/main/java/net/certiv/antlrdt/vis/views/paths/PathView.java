...
import net.certiv.antlrdt.vis.actions.PathsAddSubAction;
import net.certiv.antlrdt.vis.actions.PathsAddSupAction;
import net.certiv.antlrdt.vis.actions.PathsRemoveAction;
...
import net.certiv.antlrdt.vis.model.providers.PathLabelProvider;
...
public class PathView extends ViewPart implements IAdjustableViewPart, ISelectionListener {
	...
	public static final String ID = "net.certiv.antlrdt.vis.views.paths.PathView";
	...
	public final DslPrefsManager store;
