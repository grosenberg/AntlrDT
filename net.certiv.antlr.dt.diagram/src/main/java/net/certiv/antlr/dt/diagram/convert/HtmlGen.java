...
public class HtmlGen {
	...
	public HtmlGen(AntlrEditor editor, Converter converter) {
		this.editor = editor;
	...
	private URL findStyle(IPath path) throws Exception {
		...
		// filesystem
		IPreferenceStore store = AntlrCore.getDefault().getPrefsManager();
		...
		Bundle bundle = Platform.getBundle(AntlrUI.PLUGIN_ID);
