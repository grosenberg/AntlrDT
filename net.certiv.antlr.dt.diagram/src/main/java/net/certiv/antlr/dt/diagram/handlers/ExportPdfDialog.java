...
public class ExportPdfDialog extends MessageDialog {
	...
	public ExportPdfDialog(Shell parent, ExportPdfHandler handler, IFile source) {
	...
	private SelectionListener tmplListener = new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			String base = store.getString(PrefsKey.EDITOR_PANDOC_TEMPLATES).trim();
