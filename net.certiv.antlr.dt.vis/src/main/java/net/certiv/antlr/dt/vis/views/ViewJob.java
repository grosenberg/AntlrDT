...
public class ViewJob extends Job {
	...
	private static final String Render = "Antlr.set('%s');";
	...
	public ViewJob(ParseTreeView view) {
		super("Preview");
		this.view = view;
		this.browser = view.getBrowser();
		this.store = AntlrCore.getDefault().getPrefsManager();
	...
	public boolean load(boolean firebug) {
		AntlrDTEditor editor = view.getEditor();
		if (editor == null)
			return false;
